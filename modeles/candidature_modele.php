...
class CandidatureModele {
    ...
    public function creerCandidature(array $donnees): bool {
        $sql = "INSERT INTO candidature (id_offre, id_utilisateur, cv, lettre_motivation, date_candidature)
                VALUES (:id_offre, :id_utilisateur, :cv, :lettre_motivation, :date_candidature)";
